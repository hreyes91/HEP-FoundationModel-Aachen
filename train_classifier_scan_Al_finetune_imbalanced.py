...
log_dir='/net/data_ttk/hreyes/LHCO/IdealClassification/Supervised_imbalanced/RUN11/Classification_ALsupervised_finetune_AVGpoolhead_test_datav2_imbalanced_11/'+tag_of_train
                                        ...
                                        for num_heads in num_heads_list:
                                            for lr in lr_list:
                                                for hidden_dim in hidden_dim_list:
                                                    ...
                                                    test_command='python test_classifier_AL_imbalanced.py --data_path_1 '+data_path_1+' --data_path_2 '+data_path_2+' --model_dir '+ model_dir +'  --num_events '+str(num_events_test)+' --num_const '+str(num_const)+' --pred_name '+str('predictions_test.npz')
