...
import random
from model import JetClassifierWithAttentionPoolingCombCLS,JetClassifierWithAttentionPoolingIgCLS(nn.Module)
...
if __name__ == "__main__":
    ...
    # construct model
    model = JetClassifierWithAttentionPoolingCombCLS(
