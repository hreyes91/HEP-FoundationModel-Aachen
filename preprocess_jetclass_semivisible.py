...
# python preprocess_jetclass_semivisible.py --input_file /net/data_ttk/hreyes/Semi-Visible/semivisible-jets/qcd/constitutents/qcd_constit.h5 --output_file /net/data_ttk/lcordes/Semi-Visible/qcd/qcd_constit_disc.h5 
