...
for file in list_of_files:
    ...
    command='python preprocess_LHCO_onebinner.py --input_file /Users/humbertosmac/Documents/work/Foundation_Model/AnomalyDetection/LHCOData/low_level/original/'+str(file)+' --nBins 40 30 30 --nJets 100000 --tag '+str(file_name)+'_1Mfromeach_403030'
