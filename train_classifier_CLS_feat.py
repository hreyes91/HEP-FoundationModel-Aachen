...
import random
from model import JetTransformerClassifier,JetClassifierWithClassAttention,JetClassifierWithClassAttentionAndFeatures
...
if __name__ == "__main__":
    ...
    # construct model
    model = JetClassifierWithClassAttentionAndFeatures(
