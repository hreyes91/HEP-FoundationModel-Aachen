...
main_result_dir='/Users/humbertosmac/Documents/work/Foundation_Model/AnomalyDetection/Results/IdealizedClassification/finetune_avg_wHLF/Classification_AL_finetune_wHLF_scan_1/'
...
path_to_plots=main_result_dir
plt.savefig(path_to_plots+'/ROC_curves_finetuned.pdf')
plt.close()
...
auc_frame.to_csv(main_result_dir+'results.txt',index=False)


plot_title='LHCO-AachenT-QCDJetClass backbone-finetuned'
