...
from model_finetune import JetClassifierWithClassAttentionAndFeaturesFine
...
def get_dataloader(
    ...
    _, _, jet_mass_val=make_continues(dat_val, mask, noise=False)
    
    jet_mass_val = torch.tensor(jet_mass_val, dtype=torch.float32)
    ...
    jet_mass_val = torch.tensor(jet_mass_val[idx_val])
