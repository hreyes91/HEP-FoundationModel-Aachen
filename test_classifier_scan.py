...
mother_dir='//net/data_ttk/hreyes/JetClass/Classification_BL/top_vs_qcd//'
...
for model_dir in model_dirs:
    ...
    command='python test_classifier.py --data_path_1 '+data_path_1+' --data_path_2 '+data_path_2+' --model_dir '+ mother_dir+model_dir+'  --num_events '+str(num_events)+' --num_const '+str(num_const)+' --pred_name '+str('predictions_test.npz')
    print(command)
    try:
        os.system(command)
        print('there')
