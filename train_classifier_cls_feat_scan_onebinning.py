...
for sig in sig_list:
    for bg in bg_list:
        ...
        for num_events in num_events_list:
            ...
            tag_of_train='top_vs_qcd_jetclass_classifier_cls_test_pipeline_1_nevents'+str(num_events)
            log_dir='//net/data_ttk/hreyes/JetClass/Classification_CLS_fear/top_vs_qcd/'+tag_of_train
