...
for sig in sig_list:
    for bg in bg_list:
        ...
        for num_events in num_events_list:
            ...
            log_dir='//net/data_ttk/hreyes/JetClass/Classification_AttPoolcombCLS/top_vs_qcd/'+tag_of_train
